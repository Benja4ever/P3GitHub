        ...
        while (!salir) {
            ...
            switch (operacion) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    System.out.println("La multiplicaciÃ³n es: " + multiplicacion(operando1, operando2));
                    break;
                case 4:
                    System.out.println("La divisiÃ³n es: " + division(operando1, operando2));
                    break;
                case 5:
